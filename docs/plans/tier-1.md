...
- [x] Jeff, before or with the merge: set a monthly spend limit in the Anthropic Console's limits settings for the organisation or workspace that holds the production key, and record the amount here. Set by Jeff before the merge, 2026-09-26 (amount not recorded yet).
