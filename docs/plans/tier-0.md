...
|---|---|---|---|---|
| WP0 | Quality gates and the crash fix | PR open | `claude/tier0-wp0-quality-gates` | baseline lint was 104 problems in 32 files (97 errors, `.cjs` included), not the 100 in 3.1; all errors fixed, the 7 `exhaustive-deps` warnings remain by design (D3) |
